...
public class ReefRichesMLPWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(ReefRichesMLPWLAEngineManagerTest.class);
		logger.setLevel(Level.DEBUG);
		gameParams = XMLUtil.parseResource("paymodel/ReefRichesMLPWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/ReefRichesMLPWLAIW/InitOutcome.xml").getDocumentElement();
